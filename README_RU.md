...
Этот репозиторий — бортовой модуль восприятия и выбора цели для автономного надводного аппарата (USV).
Проект адаптирован под **морские задачи преследования и перехвата** на ограниченном вычислительном железе.

## 1) Назначение системы (в контексте USV)
...
Обучение выполняется оффлайн (рабочая станция/сервер), на USV разворачивается уже экспортированная модель.
